...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <section className="relative w-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 min-h-screen">
        <div className="w-full max-w-5xl mx-auto text-center space-y-4 sm:space-y-5">
          ...
          {/* Description */}
          <div data-aos="fade-up" data-aos-delay="100" className="w-full max-w-3xl mt-4 mx-auto px-0.5">
          ...
          >
            <div className="flex flex-row items-center justify-between gap-2 sm:gap-4 lg:gap-6">
              {/* Step 1 */}
              <div className="flex-1 flex flex-col items-center text-center">
                <div className="mb-2 p-2 sm:p-3 rounded-lg bg-gradient-to-br from-[var(--color-cyan-400-20)] to-[var(--color-cyan-400-5)] border border-[var(--color-cyan-400-30)]">
                  <MessageCircle className="w-5 sm:w-6 h-5 sm:h-6 text-[var(--color-cyan-400)] mx-auto" />
                </div>
              ...
              {/* Arrow 1 */}
              <div className="flex items-center justify-center flex-shrink-0">
                <ArrowRight className="w-4 sm:w-5 h-4 sm:h-5 text-[var(--color-cyan-400-50)]" />
              </div>

              {/* Step 2 */}
              <div className="flex-1 flex flex-col items-center text-center">
                <div className="mb-2 p-2 sm:p-3 rounded-lg bg-gradient-to-br from-[var(--color-cyan-400-20)] to-[var(--color-cyan-400-5)] border border-[var(--color-cyan-400-30)]">
                  <Zap className="w-5 sm:w-6 h-5 sm:h-6 text-[var(--color-cyan-400)] mx-auto" />
                </div>
              ...
              <div className="flex-1 flex flex-col items-center text-center">
                <div className="mb-2 p-2 sm:p-3 rounded-lg bg-gradient-to-br from-[var(--color-cyan-400-20)] to-[var(--color-cyan-400-5)] border border-[var(--color-cyan-400-30)]">
                  <Bot className="w-5 sm:w-6 h-5 sm:h-6 text-[var(--color-cyan-400)] mx-auto" />
                </div>
